...
function renderTutorial(tutorial){
	...
	<div class = "card-paths">
		...
		<a href="${tutorial['paths']['killercoda']}"><img src="./wiki-images/killercodaLogo.png" class="card-img zoom" title="Click here to try the interactive tutorial on Killercoda [Killercoda is still in Beta]"></img></a>
	</div>`
	);
